  ...
  return (
    ...
    <div className={`bg-currentBlue md:hidden  text-white  z-20 fixed bottom-0 left-0 w-full  ${isOpenMenu? " ": "overflow-hidden"} `}>
      ...
      <div className="container flex items-center justify-center gap-20">
        ...
        <a href="/catalog" className='flex flex-col items-center gap-1 text-[11px] font-notoSansDisplay cursor-pointer'>
          <IoGridOutline className="w-5 h-5 "/>
          <span>Каталог</span>
        </a>
        <a href="/contact" className='flex flex-col items-center gap-1 text-[11px] font-notoSansDisplay cursor-pointer'>
