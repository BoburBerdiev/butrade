...
const SearchPanel = () => {
    ...
    return (
        <>
            ...
            <div className={`fixed  left-0 right-0 w-full duration-200 overflow-hidden h-screen z-[90] ${searchPanel ? "top-[102px] md:top-[125px] lg:top-[131px] " : " -top-full"}   bg-currentBlue`}>
